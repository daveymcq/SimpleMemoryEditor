...
boolean CheckBit(void *address, uint8 bit)
{
...
boolean SetBit(void *address, uint8 bit)
{
    uint8 *paddress = (uint8 *)address;
...
boolean ClearBit(void *address, uint8 bit)
{
    uint8 *paddress = (uint8 *)address;
...
boolean ToggleBit(void *address, uint8 bit)
{
    uint8 *paddress = (uint8 *)address;
