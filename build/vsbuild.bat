...
if [%1] == [] (
    ...
    cl "..\main.c*" "..\resources\icon.res" /MT /link /nodefaultlib:vcruntime.lib /subsystem:windows,4.02 /out:"..\bin\x86\Simple Memory Editor (32-bit).exe"
    ...
    mkdir "..\bin\x64" 2>NUL
    rc "..\resources\icon.rc"
    cl "..\main.c*" "..\resources\icon.res" /MT /link /nodefaultlib:vcruntime.lib /subsystem:windows,5.02 /out:"..\bin\x64\Simple Memory Editor (64-bit).exe"
