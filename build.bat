...
if defined VCVARS (
    if %COMPILE_64BIT% == yes (
        ...
        cl ".\src\main.c*" ".\resources\resource.res" /MT /link /entry:mainCRTStartup /nodefaultlib:vcruntime.lib   /subsystem:windows,5.02 /out:".\bin\x64\Simple Memory Editor (64-bit).exe"
...
if defined VCVARS (
    if %COMPILE_32BIT% == yes (
        ...
        mkdir bin\x86
        rc ".\resources\resource.rc"
        cl ".\src\main.c*" ".\resources\resource.res" /MT /link /entry:mainCRTStartup /nodefaultlib:vcruntime.lib	 /subsystem:windows,4.02 /out:".\bin\x86\Simple Memory Editor (32-bit).exe"
...
if %COMPILE_64BIT% == yes (
    ...
    gcc ".\src\main.c" ".\resources\resource.o" -static -mwindows -o ".\bin\x64\Simple Memory Editor (64-bit).exe" -lcomctl32
...
if %COMPILE_32BIT% == yes (
    ...
    gcc ".\src\main.c" ".\resources\resource.o" -static -mwindows -m32 -o ".\bin\x86\Simple Memory Editor (32-bit).exe" -lcomctl32
    del ".\resources\resource.o"
