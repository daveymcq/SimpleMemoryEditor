...
rc ".\data\resource.rc"
cl ".\src\main.cpp" ".\data\resource.res" /MT /link /subsystem:windows /out:".\bin\x64\Simple Memory Editor (64-bit).exe"
cl ".\src\test.cpp" /link /subsystem:console,5.02 /out:".\bin\x64\test_x64.exe"
call "C:\Program Files (x86)\Microsoft Visual Studio 9.0\VC\vcvarsall.bat" x86
cl ".\src\main.cpp" ".\data\resource.res" /MT /link /subsystem:windows /out:".\bin\x86\Simple Memory Editor (32-bit).exe"
